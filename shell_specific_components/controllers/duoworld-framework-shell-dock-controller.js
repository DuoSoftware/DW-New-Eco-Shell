...
(function () {
    var duoWorldFrameworkShellDockCtrl = function ($rootScope, $scope, $state, $presence, $auth, $apps, $helpers, $location, $ocLazyLoad, $mdDialog, shellDataFactory, $mdToast) {
        ...
        vm.tenantSubscription = shellDataFactory.getTenantSubscription();
        //********************************************************************************************************
        ...
        function addToPanel(app, type, x, y) {
            console.log(vm.selectedPanelIndex);
            for (var a = 0; a < vm.shellConfig.docklayoutconfiguration.pannelcollection.length; a++) {
                if (vm.selectedPanelIndex == vm.shellConfig.docklayoutconfiguration.pannelcollection[a].panelArrangement) {
                    var selectedPanel = vm.shellConfig.docklayoutconfiguration.pannelcollection[a];
