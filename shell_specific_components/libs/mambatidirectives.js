...
(function (mamDirectives) {
    ...
    function componentGeneratorFunc($compile, $mdBottomSheet, $rootScope, $timeout) {
        return {
            ...
            link: function (scope, element) {
                ...
                var generatedTemplate = '<div ' + scope.component + '-component componentdata="componentdata" class="wh-inherit" componentdraggable="componentdraggable" componentdisabled="componentdisabled" ng-class="{shellExpiredBW : componentdisabled}"></div>';
                ...
                if (scope.componentdraggable) {
                    ...
                    element.bind('mousedown', function (evt) {
                        ...
                        scope._pressed = $timeout(function () {
                            scope.click = false;
                            if (scope.longPress && scope.componenteditmode) {
    ...
    function appshortcutComponentFunc2($rootScope, $scope, $element, $state, $location, $mdDialog, $mdToast, $timeout, $attrs) {
        ...
        $scope.singleClick = function (ev) {
            if (!$scope.componentdraggable && !$scope.componentdisabled) {
                console.log("click");
                console.log(ev);
