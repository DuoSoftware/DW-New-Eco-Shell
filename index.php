...
-->
                    ...
                    <md-menu md-offset="0 58">
                        <md-button ng-click="$mdOpenMenu()" aria-label="All Apps" ng-disabled="vm.tenantSubscription.expired">
                            <div layout="row" layout-align="center center"><img src="images/tennantassets/duoworldlogo.png" style="width:30px;" ng-class="{shellExpiredBW : vm.tenantSubscription.expired}"></div>
    ...
    font-weight: 300;">All Applications</span>
                                ...
                                <md-button aria-label="see all" class="md-primary" ng-click="vm.dwFrameworkBuiltinAppNavigation('market place')">
                            ...
                            <md-content layout="column" layout-align="start center">
                                <perfect-scrollbar class="systemTrayScroller" id="systemTrayScroller" wheel-propagation="false" wheel-speed="2" suppressScrollX="true" layout="row" layout-align="center start">
                                    <div layout="row" layout-align="center start" layout-wrap>
                                        <div ng-repeat="componentdata in vm.allApps | filter:globalSearchKeyword" component-generator component="'appshortcut'" componentdata="componentdata" ng-if="componentdata.Apps == undefined" componentdraggable="false" style="width:100px" componenteditmode="false"> </div>
                                        <div ng-repeat="componentdata in vm.allApps | filter:globalSearchKeyword" component-generator component="'appbundle'" componentdata="componentdata" ng-if="componentdata.Apps !== undefined" componentdraggable="false" style="width:100px" componenteditmode="false"> </div>
                                    </div>
                                </perfect-scrollbar>
...
-->
                    ...
                    <md-button ui-sref="launcher.useradmin">my</md-button>
                    ...
                    <md-menu md-position-mode="target-right target" md-offset="0 65">
                        <md-button ng-click="$mdOpenMenu()">
                            <div layout="row" layout-align="center center"> <img ng-class="{shellExpiredBW : vm.tenantSubscription.expired}" ng-src="{{$root.profilePicture}}" err-src="images/usercover4.jpg" width="30" height="30" style="border-radius:50%;">
                                <!--                                <span>&nbsp {{currenttenantsessioninfo.Username}}</span>-->
                            </div>
                        </md-button>
                        <md-menu-content layout="column" layout-align="start center" width="5" class="profile-widget {{vm.shellConfig.themeconfiguration.palettename}}-{{vm.shellConfig.themeconfiguration.theme}}" md-theme="{{vm.shellConfig.themeconfiguration.palettename}}-{{vm.shellConfig.themeconfiguration.theme}}" md-theme-watch="true">
                            <div layout="column" layout-align="start center" style="width:100%">
                                <img ng-class="{shellExpiredBW : vm.tenantSubscription.expired}" ng-src="{{$root.profilePicture}}" err-src="images/usercover4.jpg" style="width:320px;height:320px;">
...
-->
        ...
        <div background-component id="backgroundImage" ng-class="{shellExpiredBW : vm.tenantSubscription.expired}" style="background-image:url({{vm.shellConfig.backgroundconfiguration[2].backgroundimageconfig.imageurl}});"></div>
        <!--        </div>-->
