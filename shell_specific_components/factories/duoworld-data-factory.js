angular.module('mambatiFrameworkShell').factory('shellDataFactory', function ($presence, $http, $auth, $objectstore, $rootScope, $q) {
    ...
    return {
        ...
        setTenantSubscription: function (data) {
            factory.tenantSubscription = data;
        },
        getTenantSubscription: function () {
            return factory.tenantSubscription;
        },
        getAccountCards: function () {
            return factory.account.AccountCards;
        },
        setAccountCards: function (data) {
            factory.account.AccountCards = data;
        }
